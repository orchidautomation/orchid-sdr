...
This is the canonical path for getting one Trellis reference-app demo live with the least confusion.
...
Get the reference app to a deployed state where:
...
- you are using the reference app in `examples/reference-app/`
...
The minimum practical hosted stack for the current reference app is:
...
- `examples/reference-app/knowledge/icp.md`
- `examples/reference-app/knowledge/product.md`
- `examples/reference-app/knowledge/usp.md`
- `examples/reference-app/knowledge/compliance.md`
- `examples/reference-app/knowledge/negative-signals.md`
- `examples/reference-app/knowledge/handoff.md`

Then review:

- `examples/reference-app/skills/icp-qualification`
- `examples/reference-app/skills/research-brief`
- `examples/reference-app/skills/research-checks`
- `examples/reference-app/skills/sdr-copy`
- `examples/reference-app/skills/reply-policy`
- `examples/reference-app/skills/handoff-policy`
...
## 10. Optional Full Reference App Stack
...
The reference app is live when:
