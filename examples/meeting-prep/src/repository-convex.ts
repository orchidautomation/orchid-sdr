...
function mapMeeting(record: any): MeetingRecord {
  return {
    ...
    companyWebsite: record.companyWebsite ?? null,
    companyIndustry: record.companyIndustry ?? null,
    companyDescription: record.companyDescription ?? null,
    companyLinkedinUrl: record.companyLinkedinUrl ?? null,
