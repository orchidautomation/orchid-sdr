  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      await ctx.db.patch(existing._id, {
        ...
        accountName: payload.meeting.accountName ?? payload.meeting.company?.name,
        objective: payload.meeting.objective,
        notes: payload.meeting.notes,
        sourceUrl: payload.meeting.sourceUrl,
        companyDomain: payload.meeting.company?.domain,
        companyWebsite: payload.meeting.company?.website,
        companyIndustry: payload.meeting.company?.industry,
        companyDescription: payload.meeting.company?.description,
        companyLinkedinUrl: payload.meeting.company?.linkedinUrl,
        updatedAt: timestamp,
      });
    } else {
