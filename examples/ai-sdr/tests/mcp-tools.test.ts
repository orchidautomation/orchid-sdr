...
import { TrellisMcpToolService } from "../src/services/mcp-tools.js";

describe("TrellisMcpToolService operator tools", () => {
  beforeEach(() => {
    mockClient = {
  ...
  function createService() {
    ...
    const context = {
      ...
      config: {
        ...
        AGENTMAIL_DEFAULT_SENDER_NAME: "Trellis",
        AGENTMAIL_DEFAULT_INBOX_DOMAIN: undefined,
      },
    } as any;

    return {
      service: new TrellisMcpToolService(context),
      repository,
      attio,
      context,
    };
