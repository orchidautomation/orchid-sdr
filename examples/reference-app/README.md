...
This directory contains the reference Trellis app. It currently demonstrates the AI SDR workflow.
...
The example skill pack is runtime-only. Setup and deployment guidance lives in the repo docs and generated setup checklists, not in `examples/reference-app/skills/`.
...
4. [../../docs/reference-app-go-live.md](../../docs/reference-app-go-live.md)
...
2. [../../docs/reference-app-go-live.md](../../docs/reference-app-go-live.md)
...
- [Reference App Go-Live](../../docs/reference-app-go-live.md)
